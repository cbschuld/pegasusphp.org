<?php 
	...
	class Grid3Static {
		...
		public function &createColumn($strTitle,$strColumn='') {
			$column = new Grid3StaticColumn($strTitle,$strColumn);
		...
		public function getMarkup() {
			...
			if( count($this->_data) >= 0 ) {
				...
				$xhtml = "<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"display\" style=\"width:100%;\" id=\"{$this->getId()}\">";
				$xhtml .= "<thead>";
				$xhtml .= "<tr>";
				$xhtml .= $xhtmlHeader;
				$xhtml .= "</tr>";
