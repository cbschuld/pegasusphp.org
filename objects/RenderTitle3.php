<?php
	/**
	 * RenderTitle3 creates a title object object in XHTML without a general reliance
	...
	class RenderTitle3 {
		...
		public function setFloat($leftORright) {
			...
			if( $this->_float != '' && $this->_float != 'left' && $this->_float != 'right' ) {
				die('Error: attempt to call RenderTitle3::setFloat() with an invalid value');
			}
			return $this;
		}
		...
		public function getLineColor() {
			$color = '';
			if( $this->_linecolor == '' && Settings::RENDER_TITLE_LINE_COLOR != '' ) {
				$color = Settings::RENDER_TITLE_LINE_COLOR;
			}
			else if( $this->_linecolor == '' && $this->_linecolor != '' ) {
				$color = $this->getColor();
				$color = WebColor::increment($this->getColor(),Settings::RENDER_TITLE_LINE_COLOR);
			}
			else if( $this->_linecolor == '' && $this->_linecolor == '' ) {
		...
		public function render() {
	    	...
	    	$xhtml .= 'border-top: 2px solid #'.$this->getLineColor().';';
