...
/*
$Id: nusoap.php,v 1.4 2010/03/16 21:58:12 cbschuld Exp $
...
if( ! isset($GLOBALS['_transient']) ) {
	$GLOBALS['_transient'] = null;
}
if( ! isset($GLOBALS['_transient']['static']) ) {
	$GLOBALS['_transient']['static'] = null;
}
...
* @version  $Id: nusoap.php,v 1.4 2010/03/16 21:58:12 cbschuld Exp $
* @access   public
*/
class nusoap_base {
	/**
